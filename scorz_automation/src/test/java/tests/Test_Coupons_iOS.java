...
import pageObjects.FeedsiOS;
import utils.MethodsIOS;
import utils.TestResult;

public class Test_Coupons_iOS {
	...
	public void setUp() throws MalformedURLException, InterruptedException {
	    ...
	    caps.setCapability("os_version", "13.4");
	    caps.setCapability("platformName","iOS");
		caps.setCapability("automationName", "XCUITest");
		caps.setCapability("browserstack.networkLogs","true");
		
		caps.setCapability("app", "bs://ca0b277071f38068e654463dc43f71d904bc766b"); // Sales - iOS - Jul-14-1.8.0- Prod
		//caps.setCapability("app", "bs://c03b6c9a3d0c2cc54023d6a33bae85b46f7f23c3"); // Scorz -iOS - Apr -29 - 2.10.0 - Prod
		//caps.setCapability("app", "bs://ab2084cfc11018268195fde0cdcee260a7d84654"); // Scorz - iOS - Apr - 2 - 2.9.2 - Prod
		//caps.setCapability("app", "bs://f078d05ef0ba32cf340336326ffd9a74a6d70bf4"); // Scorz - iOS - Feb - 26 - 2.8.2 - Canary
		//caps.setCapability("app", "bs://bb48a91e44f020b4b1d698bb44b49e76bb12e4b8"); // Scorz - iOS - Feb - 22 - 2.8.1 - Canary
	...
	@Test
	public void logintestiOS() throws Exception {
		
		boolean testresult;
		MethodsIOS methodios = new MethodsIOS(driver);
		LoginAndCreateAccountiOS accountios = new LoginAndCreateAccountiOS(driver);
		CouponsPageiOS couponiOS = new CouponiosPageiOS(driver);
		MatchDayiOS matchesiOS = new MatchDayiOS(driver);
		FeedsiOS feedsiOS = new FeedsiOS(driver);
		
		TestResult ts = new TestResult();
		
		testresult = accountios.logIn_iOS_Scorz(test);
		testresult = feedsiOS.twitterFeed(test);
		testresult = matchesiOS.matchDay(test);
...
@Test
	public void logintestiOS() throws Exception {
		...
		MethodsIOS methodios = new MethodsIOS(driver);
		LoginAndCreateAccountiOS accountios = new LoginAndCreateAccountiOS(driver);
		CouponsPageiOS couponiOS = new CouponsPageiOS(driver);
		MatchDayiOS matchesiOS = new MatchDayiOS(driver);
		FeedsiOS feedsiOS = new FeedsiOS(driver);

...
public class Test_SignUp_Email {
	...
	test = report.startTest("Scorz Automation SignUp and Create Account - EMail");
	...
	@Test
	public void signUpEmailtest() throws IOException, InterruptedException {
		boolean testresult;
		...
		testresult = login.createAccountwithEmail(test);
		Thread.sleep(10000);
		...
		ts.markFinal("Create Account", testresult, "Creating a new Account by Signing Up with Email", test);
	}
